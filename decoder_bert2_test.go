...
func TestDecodeSimple(t *testing.T) {
	...
	err := bert.DecodeReply2(buf, &result)
	if err != nil {
...
func TestDecodeErrorReply2(t *testing.T) {
	// {reply, {error, exists}}
...
func TestDecodeOkReply2(t *testing.T) {
	// {reply, {ok, 110}}
...
func TestDecodeReplyToNil2(t *testing.T) {
	// {reply, {ok, 110}}
	input := []byte{0, 0, 0, 20, 131, 104, 2, 100, 0, 5, 114, 101, 112, 108, 121, 104, 2, 100, 0, 2, 111, 107,
		97, 110}

	buf := bytes.NewBuffer(input)
	err := bert.DecodeReply2(buf, nil)
	if err == nil {
		t.Errorf("bert decoding to nil should fail")
	}
}

func TestDecodeOkStruct2(t *testing.T) {
